...
## Table of Contents
- [Why Dongle-Free Matters](#why-dongle-free-matters)
- [Bluetooth vs 2.4 GHz: The Real Differences](#bluetooth-vs-24-ghz-the-real-differences)
- [Comparison Table: 5 Best Wireless Vertical Mice](#comparison-table-5-best-wireless-vertical-mice)
- [Detailed Reviews](#detailed-reviews)
- [Multi-Device Pairing: How It Works](#multi-device-pairing-how-it-works)
- [Battery Life: What Actually Matters](#battery-life-what-actually-matters)
- [Latency: Does It Matter for Your Work?](#latency-does-it-matter-for-your-work)
- [Mac, Windows, and Linux Compatibility](#mac-windows-and-linux-compatibility)
- [The Clean Desk Setup](#the-clean-desk-setup)
...
1. **Pair the mouse** with Device 1 (work laptop), Device 2 (personal desktop), and Device 3 (tablet).
2. **Press the device-switch button** on the mouse bottom to select which device is active.
3. **The cursor appears on the selected device** within 1–2 seconds.
