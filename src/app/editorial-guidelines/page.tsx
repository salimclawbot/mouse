  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>Every guide and review published on Vertical Mouse Guide is thoroughly researched before publication. Our writers draw on peer-reviewed research, expert interviews, and specification-based product comparison and independent owner feedback to ensure the information we provide about ergonomic vertical mice and wrist health is accurate, up-to-date, and genuinely useful.</p>
      </section>
