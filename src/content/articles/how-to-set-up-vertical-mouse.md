...
- [Why Correct Setup Matters](#why-correct-setup-matters)
- [Step 1 — Position Your Desk and Chair First](#step-1-position-your-desk-and-chair-first)
- [Step 2 — Place the Mouse at the Right Height](#step-2-place-the-mouse-at-the-right-height)
- [Step 3 — Align Your Arm and Elbow](#step-3-align-your-arm-and-elbow)
- [Step 4 — Adjust Mouse Sensitivity and DPI](#step-4-adjust-mouse-sensitivity-and-dpi)
- [Step 5 — Configure Software and Buttons](#step-5-configure-software-and-buttons)
- [Common Setup Mistakes to Avoid](#common-setup-mistakes-to-avoid)
- [Vertical Mouse Setup for Different Work Types](#vertical-mouse-setup-for-different-work-types)
- [How Long Until You Feel the Difference?](#how-long-until-you-feel-the-difference)
...
1. Set your OS pointer speed to the **middle/default** position
2. **Disable pointer acceleration** (called "Enhance pointer precision" in Windows, controlled via terminal or third-party tools on macOS)
3. Use the mouse's hardware DPI to control actual speed
...
![Infographic showing 5 common vertical mouse setup mistakes with visual corrections](/images/guides/how-to-set-up-vertical-mouse/setup-mistakes-infographic.jpg)
...
If you're choosing a vertical mouse specifically for office use, our [best vertical mouse for office work](/guides/best-vertical-mouse-office) guide has tested recommendations.

![Chart comparing optimal vertical mouse DPI settings for different work types: coding, design, office](/images/guides/how-to-set-up-vertical-mouse/dpi-settings-by-work-type-infographic.jpg)
*DPI and sensitivity settings optimised by work type*

![Photo of a person testing their vertical mouse reach with neutral wrist position](/images/guides/how-to-set-up-vertical-mouse/neutral-wrist-reach-test.jpg)
